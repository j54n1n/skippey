...
/** Soundcloud plugin. */
public final class SoundcloudPlugin extends LocalMediaKeyPlugin {

    private static final String TAG = makeLogTag(SoundcloudPlugin.class);

    // Soundcloud media notification button title.
    ...
    public SoundcloudPlugin(Context context) throws PackageManager.NameNotFoundException,
            UnsupportedOperationException {
        super(context, R.string.plugin_soundcloud, R.string.plugin_soundcloud_pkg,
                R.string.plugin_soundcloud_desc
        );
    }
